...
|----------|------------|
| 📘 [Requirements Specification](C:\Users\debmo\OneDrive\Desktop\CYRA\.kiro\specs\cyra-ai-inbox-agent/requirements.md) | User stories, MVP scope, agent capabilities, safety constraints |
